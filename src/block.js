...
class Block {
    ...
    getBData() {
        ...
        return new Promise((resolve, reject) => {
            ...
            let decodeData = JSON.parse(hex2ascii(encodeData));
            if (decodeData && self.height > 0) {
                resolve(decodeData);        // Resolve with the data if the object isn't the Genesis block
            } else {
