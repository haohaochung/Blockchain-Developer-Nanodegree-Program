...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, 'Contract current is paused');
        _;
    }

    modifier paused() {
        require(_paused == true, 'Contract current is not paused');
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(tokenOwner != to, 'Can not approve yourself');
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(tokenOwner == msg.sender || isApprovedForAll(tokenOwner, msg.sender), "Caller is not authorized against this token");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0) && _tokenOwner[tokenId] == address(0));
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "From address is not the owner of this token") ;
